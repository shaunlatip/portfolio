            ...
            <div className={styles.headline}>
              <div className={styles.headlineContent}>
                ...
                <p className={styles.subHeadline}>
                  I'm a <span style={{ fontWeight: 600 }}>designer</span> and{" "}
                  <span style={{ fontWeight: 600 }}>researcher</span> working to
                  shape a more inclusive, intentional digital world.
                  <br />
                  Take a look at some of my work below to learn a bit more about
                  how I tick.
                </p>
              ...
              <Link href="/checkin">
                ...
                <div className={styles.projectInfo}>
                  <div className={styles.projectInfoContent}>
                    ...
                    <p>
                      Field research and interviews examining the front-door
                      clinical experience
                    </p>
                  </div>
                </div>
              ...
              <Link href="/pokemon-ranch">
                ...
                <div className={styles.projectInfo}>
                  <div className={styles.projectInfoContent}>
                    ...
                    <p>
                      Interactive React web app to browse and make a team from
              ...
              <Link href="/blt">
                ...
                <div className={styles.projectInfo}>
                  <div className={styles.projectInfoContent}>
                    ...
                    <p>
                      Running virtual research on how we think and speak at a
                      Brown University psychology research lab
                    </p>
                  </div>
                </div>
              </Link>
        ...
        >
          ...
          <div className={styles.otherProjects}>
            <div className={styles.otherProject}>
              <Link
                href="https://www.browndailyherald.com/article/2021/10/richie-engn-robots"
                target="_blank"
              >
                <Image
                ...
                <div className={styles.otherProjectInfo}>
                  <div className={styles.otherProjectInfoContent}>
                    ...
                    <p>
                      Designing and coding an Arduino-powered split-flap display
                      for an artistic robotic installation.
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <div className={styles.otherProject}>
              <Link
                href="https://drive.google.com/file/d/1BDbKiPABNon0NO-FpfMnJBnjMC8lRFDQ/view"
                target="_blank"
              >
                <Image
                ...
                <div className={styles.otherProjectInfo}>
                  <div className={styles.otherProjectInfoContent}>
                    <h3>Scallop-Bot</h3>
                    <p>
                      Designer, engineer, and coder for an Arduino-based robotic
                      art installation.
                    </p>
                  </div>
                </div>
            ...
            <div className={styles.otherProject}>
              <Link
                href="https://shaunlatip.github.io/Pokemon-Ranch/"
                target="_blank"
              >
                <Image
                ...
                <div className={styles.otherProjectInfo}>
                  <div className={styles.otherProjectInfoContent}>
                    <h3>Pokemon Ranch</h3>
                    <p>
                      React web app that lets you browse and choose a Pokemon
                      team.
                    </p>
                  </div>
                </div>
